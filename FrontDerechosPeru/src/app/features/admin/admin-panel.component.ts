...
export class AdminPanelComponent {
  ...
  readonly gestionCards: AdminCard[] = [
    ...
    {
      title: 'Ingesta de Constituciones',
      description: 'Sube el PDF de una constitución, revísalo artículo por artículo contra el documento y publícalo como una nueva versión comparable.',
      icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
